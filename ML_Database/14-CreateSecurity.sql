...
grant select on LeasesDetails to Manager;
...
grant execute on TerminateLeaseUpdates to Manager;
grant execute on CalculatePremiumFee to Manager;


--granting permissions to Associate role
grant select on DetailedVehicle to Associate;
grant select on LeasesDetails to Associate;
