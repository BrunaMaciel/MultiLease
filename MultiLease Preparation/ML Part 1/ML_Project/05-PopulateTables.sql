...
insert into Leases (LeaseID, ContractDate,FirstPaymentDate,MonthlyPayment,NumOfPayments,VehicleID,CustomerID,TermsID)
values (2006, '01-07-2006','15/07/2006',300,12,
(select VIN from Vehicles where VIN = 'M21L1-3129S-V1292-L12X2'), 
(select CustomerID from Customers where FirstName='Inna' and LastName = 'Chambers'), 1006);

--Populate Payments
insert into Payments (LeaseID, Amount, PaymentDate) values (2001,650,15/02/2004);
insert into Payments (LeaseID, Amount, PaymentDate) values (2002,350,16/04/2004);
insert into Payments (LeaseID, Amount, PaymentDate) values (2003,600,01/05/2004);
insert into Payments (LeaseID, Amount, PaymentDate) values (2004,450,01/03/2002);
insert into Payments (LeaseID, Amount, PaymentDate) values (2005,300,15/07/2004);
insert into Payments (LeaseID, Amount, PaymentDate) values (2001,300,15/07/2006);